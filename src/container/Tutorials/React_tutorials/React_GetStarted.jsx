...
const React_GetStarted = () => {
  ...
  return (
    <Box>
      ...
      <TutorialContent
        content={
          "To get an overview of what React is, you can write React code directly in HTML.<br/> But in order to use React in production, you need npm and Node.js installed."
        }
      />
      <Divider sx={{ my: 1 }} />
      ...
      <TutorialContent
        content={
          "Start by including three scripts, the first two let us write React code in our JavaScripts, and the third, Babel, allows us to write JSX syntax and ES6 in older browsers.<br/>You will learn more about JSX in the React JSX chapter."
        }
      />
      <TutorialContent
